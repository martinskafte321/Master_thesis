...
print(xtable(as.data.frame(emptylist_pos_2[[5]][2]),type="latex",
             digits=c(0,4,2,3,2,0,1,1,1,1),
             hline.after=c(-1,0),
             floating=FALSE,latex.environments=NULL),
      include.rownames=FALSE,
      include.colnames = TRUE) %>% 
  write(file="alpha_positive_FF3_2.tex")
```
...
print(xtable(as.data.frame(emptylist_neg_2[[5]][3]),type="latex",
      ...
      include.rownames=FALSE,
      include.colnames = TRUE) %>% 
  write(file="alpha_negative_FF5_15.tex")
