...
\centering
\subfloat[first]{
  \includegraphics[width=70mm]{Projekt/1.Figures analysis/LT_positive_returns_1.png}
}
\subfloat[second]{
  \includegraphics[width=70mm]{Projekt/1.Figures analysis/LT_positive_returns_3.png}
}
\hspace{0mm}
\subfloat[third]{
  \includegraphics[width=65mm]{Projekt/1.Figures analysis/LT_positive_returns_6.png}
}
\subfloat[forth]{
  \includegraphics[width=65mm]{Projekt/1.Figures analysis/LT_positive_returns_12.png}
}
...
\centering
\subfloat[first]{
  \includegraphics[width=70mm]{Projekt/1.Figures analysis/LT_negative_returns_1.png}
}
\subfloat[second]{
  \includegraphics[width=70mm]{Projekt/1.Figures analysis/LT_negative_returns_3.png}
}
\hspace{0mm}
\subfloat[third]{
  \includegraphics[width=65mm]{Projekt/1.Figures analysis/LT_negative_returns_6.png}
}
\subfloat[forth]{
  \includegraphics[width=65mm]{Projekt/1.Figures analysis/LT_negative_returns_12.png}
}
