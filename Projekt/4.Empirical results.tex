...
\begin{tabular}{llllll}
 ...
 \hline
Positive news & $\underset{(2.123)^{**}}{0.081}$  & $\underset{(-0.211)}{-0.016}$    &  $\underset{(-0.379)}{-0.043}$ & $\underset{(-1.091)}{-0.164}$ & 3.500 \\ 
Negative news & $\underset{(-3.509)^{***}}{-0.378}$  & $\underset{(-5.749)^{***}}{-0.917}$    & $\underset{(-4.761)^{***}}{-0.955}$ & $\underset{(-3.288)^{***}}{-0.888}$ & 1.500\\ 
   \hline
